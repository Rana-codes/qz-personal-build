...
const QString QZSettings::default_tile_preset_resistance_1_label = QStringLiteral("R 0");
...
const QString QZSettings::default_tile_preset_resistance_2_label = QStringLiteral("R 15");
...
const QString QZSettings::default_tile_preset_resistance_3_label = QStringLiteral("R 20");
